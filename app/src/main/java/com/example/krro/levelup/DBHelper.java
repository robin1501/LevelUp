...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String INSERT_WORKOUT_POS = "INSERT INTO workoutpos (w_id, u_id) "
            ...
            + "UNION ALL SELECT 2, u_id FROM uebungen WHERE ruecken = 1 "
            + "UNION ALL SELECT 3, u_id FROM uebungen WHERE beine = 1 "
            + "UNION ALL SELECT 4, u_id FROM uebungen WHERE bizeps = 1 OR trizeps = 1 "
            + "UNION ALL SELECT 5, u_id FROM uebungen WHERE brust = 1;";
